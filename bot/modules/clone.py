...
from bot.helper.ext_utils.bot_utils import new_thread, is_gdrive_link, is_appdrive_link, is_gdtot_link, is_sharer_link, is_hubdrive_link
from bot.helper.ext_utils.clone_status import CloneStatus
from bot.helper.ext_utils.exceptions import DDLException
from bot.helper.ext_utils.parser import appdrive, gdtot, sharer, hubdrive_dl
...
def cloneNode(update, context):
    ...
    if (is_appdrive or is_gdtot or is_sharer or is_hubdrive):
        try:
    ...
    if is_gdrive_link(link):
        ...
        if (is_gdtot or is_sharer or is_hubdrive):
        ...
        sendMessage("Send a Drive/AppDrive/DriveApp/GDToT/Sharer/hubdrive/drivehub link along with command!", context.bot, update)
